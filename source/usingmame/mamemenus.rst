...
* **Player 1 ~ 10 controls**
  ...
  separado por jogador, entre o jogador 1 até o 10. Abaixo tem a lista
  das opções que podem ser configuradas, como a lista é repetida a
  mesma vale para todas as outras configurações.
