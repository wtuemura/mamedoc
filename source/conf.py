...
project = u'Documentação - MAME'
copyright = u'2018, Equipe de Desenvolvimento do MAME (MAMEdev), Tradução e Revisão Wellington T. Uemura'
...
latex_documents = [
  ('index', 'MAME.tex', u'Documentação - MAME',
...
texinfo_documents = [
  ('index', 'MAME', u'Documentação - MAME',
